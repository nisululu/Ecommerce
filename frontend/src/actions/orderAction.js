...
export const createOrder = (order) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post("https://ecommerce-backend-vemg.onrender.com/api/v1/order/new", order, config)
...
export const myOrder = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("https://ecommerce-backend-vemg.onrender.com/api/v1/orders/me")
        dispatch({
...
export const getSingleOrderDetail = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://ecommerce-backend-vemg.onrender.com/api/v1/order/${id}`)
...
export const ordersAdmin = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://ecommerce-backend-vemg.onrender.com/api/v1/admin/orders`)
...
export const updateOrder = (id, updatedData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`https://ecommerce-backend-vemg.onrender.com/api/v1/admin/order/${id}`, updatedData, config)
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`https://ecommerce-backend-vemg.onrender.com/api/v1/admin/order/${id}`)
